...
dat1 <- bind_rows(replicate(nreps, soft_selection(K=100, N_local=100, F=0, p_local_hard_unique=p, p_nonlocal_hard_unique=p, p_local_soft_unique = p, p_nonlocal_soft_unique=p, h2_init=0.25, soft_switch = TRUE, Wmax = 0.75, Theta=0, num_loci_shared = 28), simplify = FALSE))
